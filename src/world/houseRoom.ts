...
export function drawHouseCube(layout: string[], left: number, top: number, width: number, height: number) {
...
export function carveHouseDoor(layout: string[], left: number, top: number, width: number, height: number) {
  const bottom = top + height - 1;
