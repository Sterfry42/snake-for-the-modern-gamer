...
const HARVEST_BRANCH: BranchConfig = {
  ...
  nodes: [
    ...
    },
    {
      ...
      ranks: [
        {
          description: '+2 segments instantly',
          cost: 10,
          effects: [{ type: 'instantGrow', segments: 2 }],
        },
        {
          description: '+3 more segments',
          cost: 24,
          effects: [{ type: 'instantGrow', segments: 3 }],
        },
        {
          description: '+4 more segments',
          cost: 50,
          effects: [{ type: 'instantGrow', segments: 4 }],
        },
      ],
    },
    {
  ...
  nodes: [
    ...
    },
    {
      ...
      ranks: [
        {
          description:
            'Unlock Hunt Momentum (combo window 28 ticks, +15% score per stack, max 4 stacks).',
          cost: 18,
          effects: [
            {
              type: 'setFlag',
    ...
    },
    {
      ...
      ranks: [
        {
          description:
            '+6 combo window ticks, +6 decay grace, +5% score per stack, scent lasts 10 ticks.',
          cost: 66,
          effects: [
            {
              type: 'setFlag',
    ...
    },
    {
      ...
      ranks: [
        {
          description:
            '+2 max stacks, +4 window ticks, +6 decay grace, Frenzy lasts +4 ticks and triggers at one fewer stack.',
          cost: 108,
          effects: [
            {
              type: 'setFlag',
    ...
    },
    {
      ...
      ranks: [
        {
          description:
            'Gain +1 stack when entering a room and decay drops more slowly; Frenzy lasts +4 ticks.',
          cost: 126,
          effects: [
            {
              type: 'setFlag',
    ...
    },
    {
      ...
      ranks: [
        {
          description:
            'Finisher unlock: spend 6 stacks during Frenzy for +10 score, +2 growth (18 tick cooldown).',
          cost: 148,
          effects: [
            {
              type: 'setFlag',
      ...
      ranks: [
        {
          ...
          cost: 32,
          effects: [{ type: 'setFlag', key: 'geometry.wallSenseRadius', value: 2, resetValue: 0 }],
        },
      ],
    },
    {
      ...
      ranks: [
        {
          ...
          effects: [
            {
              type: 'setFlag',
              key: 'geometry.collapseControlEnabled',
              value: true,
              resetValue: false,
            },
          ],
