...
export const ISLAND_DEFINITIONS: ReadonlyArray<IslandDefinition> = [
  {
    ...
    stages: [
      ...
      },
      {
        ...
        rewards: [
          { kind: 'score', amount: 500 },
          { kind: 'ability', abilityId: 'fire-resistant-mutation' },
        ],
      },
    ],
  },
  {
    ...
    stages: [
      ...
      },
      {
        ...
        rewards: [
          { kind: 'score', amount: 500 },
          { kind: 'ability', abilityId: 'light-prism-ability' },
        ],
      },
    ],
  },
  {
    ...
    stages: [
      ...
      },
      {
        ...
        rewards: [
          { kind: 'score', amount: 500 },
          { kind: 'ability', abilityId: 'underwater-breathing' },
        ],
      },
    ],
  },
  {
    ...
    stages: [
      ...
      },
      {
        ...
        rewards: [
          { kind: 'score', amount: 500 },
          { kind: 'ability', abilityId: 'glider-ability' },
        ],
      },
    ],
  },
  {
    ...
    stages: [
      ...
      },
      {
        ...
        rewards: [
          { kind: 'score', amount: 500 },
          { kind: 'ability', abilityId: 'artifact-collection' },
        ],
      },
    ],
  },
  {
    ...
    stages: [
      ...
      },
      {
        ...
        rewards: [
          { kind: 'score', amount: 1000 },
          { kind: 'ability', abilityId: 'clone-ability' },
        ],
      },
    ],
  },
