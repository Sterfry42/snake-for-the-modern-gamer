...
export const PROVENCE_ENCOUNTERS: readonly WandererEncounter[] = [
  {
    id: 'lavender-farmer',
    name: 'The Lavender Keeper',
    kind: 'flavor',
    weight: 1.0,
    minRoomsVisited: 2,
    zoneTags: ['surface', 'upper'],
    biomeIds: ['provence-valley'],
    portraitId: 'sage-1',
    pages: [
  ...
  {
    id: 'cheese-monger',
    name: 'The Aged Cheese Monger',
    kind: 'flavor',
    weight: 0.8,
    minRoomsVisited: 2,
    zoneTags: ['surface', 'lower'],
    biomeIds: ['provence-valley'],
    portraitId: 'sage-1',
    pages: [
