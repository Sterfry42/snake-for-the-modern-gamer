...
export const FISH_DEFINITIONS: readonly FishDefinition[] = [
  ...
  },
  {
    typeId: 'green-frog',
    name: 'Green Frog',
    description: 'A plump marsh frog that croaks indignantly when reeled in.',
    biomeId: 'verdigris-basin',
    rarity: 'uncommon',
    baseScore: 4,
    minWeight: 0.4,
  ...
  },
  {
    typeId: 'moon-frog',
    name: 'Moon Frog',
    description: 'A pale frog that glows faintly in the dark. Hops away if you blink.',
    biomeId: 'gloam-garden',
    rarity: 'uncommon',
    baseScore: 5,
    minWeight: 0.3,
  ...
  },
  {
    typeId: 'swamp-frog',
    name: 'Swamp Frog',
    description: 'A mottled survivor of the deep swamp. Leaps off the hook with gusto.',
    biomeId: 'elderwood-maze',
    rarity: 'uncommon',
    baseScore: 5,
    minWeight: 0.5,
  ...
  },
  {
    typeId: 'desert-frog',
    name: 'Desert Frog',
    description: 'Survives the worst of it. Croaks like a broken hinge.',
    biomeId: 'liberty-badlands',
    rarity: 'uncommon',
    baseScore: 4,
    minWeight: 0.3,
